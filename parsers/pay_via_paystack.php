...
require $_SERVER['DOCUMENT_ROOT'].'quipbuy/includes/paystack/src/autoload.php';
$email = $_POST['cout_email'];
$amount = $_POST['cout_amount'];
$reference = $_POST['cout_tid'];
// require 'includes/paystack/src/autoload.php';
...
require $_SERVER['DOCUMENT_ROOT'].'quipbuy/includes/paystack/src/Paystack.php'; 
...
$paystack = new Yabacon\Paystack(PAYSTACK_PRIVATE);
    try
    {
    ...
    save_last_transaction_reference($tranx->reference);
...
// $paystack = new Paystack('<?=PAYSATCK_PUBLIC;?');
