...
<div style="height:2rem;display:block"><div class="progress hide">
  ...
  <div class="house" id="_<?php echo str_replace(' ','_',$page_title); ?>"><div class="row" id="new_form" style="display:none"> <div class="left-desc"><div class="row"><div class="col s12">
        ...
        <div class="">
          <div class="card hoverable">
            <div class="card-content">
              <div class="row"><div class="input-field col s3"><input  id="_qty" type="number" value="1"/><label for="qty" class="active" >Qty</label></div><div class="input-field col s9"><i class="material-icons prefix">search</i><input class="" type="text" id="_item" /><label for="_item" class="active">Item</label></div></div>
	...
	<div class="collection panel" id="_invoice_list" style="display:none"></div>
            ...
            <div class="card-action right-align"><div class="left">
               <a href="#" class="waves-effect waves-light disable" id='_show_invoiceitem'><i class="material-icons" style='font-size:1.5rem'>dns</i></a><a href="#" class="waves-effect waves-light disable" id='_show_invoice'><i class="material-icons" style='font-size:1.5rem'>event_note</i></a><a href="#" class="waves-effect waves-light" id='_show_category'><i class="material-icons" style='font-size:1.5rem'>line_weight</i></a><a href="#" class="waves-effect waves-light disable" id='_show_categoryitem'><i class="material-icons" style='font-size:1.5rem'>playlist_add_check</i></a></div><a href="#" class="waves-effect waves-light btn white-text"><i class="medium material-icons">send</i></a>
  ...
  <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
    ...
    <ul>
	     <li><a data-position="left" data-delay="50" data-tooltip="Close Window" class="tooltipped btn-floating blue" id="close"><i class="material-icons">close</i></a></li>
      <li><a data-position="left" data-delay="50" data-tooltip="Delete" class="tooltipped btn-floating red" id="_singleDelete"><i class="material-icons">delete</i></a></li>
      <li><a data-position="left" data-delay="50" data-tooltip="Reset Form" class="tooltipped btn-floating green" id="formReset"><i class="material-icons">replay</i></a></li><li><a data-position="left" data-delay="50" data-tooltip="Save" class="tooltipped btn-floating pink" id="formSave"><i class="material-icons">save</i></a></li>
...
<div class="open_diplay_box" id="open_form"  >
  ...
  <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
    <a data-position="left" data-delay="50" data-tooltip="Create New <?php echo $page_title ?>" class="tooltipped btn-floating btn-large red">
      <i class="large material-icons" id="new">add</i>
    </a>
    <ul>
      <li><a data-position="left" data-delay="50" data-tooltip="Delete" class="tooltipped btn-floating blue" id="_multiDelete"><i class="material-icons">delete</i></a></li>
	  <li><a data-position="left" data-delay="50" data-tooltip="Print" class="tooltipped btn-floating green" id="_multiPrint"><i class="material-icons">print</i></a></li>
    </ul>
  </div>
 </div>
      </div>
