<?php
		//Invoice Parameter
	$param["invoice"]=array("t"=>"transactions","c"=>"date,Date,s,a|ref,reference,b,a|customer,customer,s,a|amount,amount,s,a",'idcol'=>'trans_no','filter'=>"sub=0 and trans_type='INV'",'page_title'=>'Sales Invoice','_type'=>'INV','_account'=>"account_receivable",'_glaccount'=>"sales","_sign"=>'-1','client'=>'Customer','c_type'=>'1',"_category"=>"date,Date,period,today|wharehouse,Location,warehouse","_customer_invoiceitem"=>"0","_payment"=>1,"_applied_credit"=>1);
	...
	$param["purchase"]["_form"]["middle"]="itemid,&nbsp;Item,s12 m1,i|description,&nbsp;Description,s12 m4,i|account,Account,s12 m1,i|quantity,Qty,s12 m1,i|rate,Rate,s12 m1,i|amount,Amount,s12 m2,i|joborder,Job,s12 m2,i";
		...
		//Receipt Parameter
	$param["receipt"]=array("t"=>"transactions","c"=>"date,Date,s,a|ref,reference,b,a|customer,customer,s,a|amount,amount,s,a",'idcol'=>'trans_no','filter'=>"sub=0 and trans_type='RCP'",'page_title'=>'Receipt','_type'=>'RCP','_glaccount'=>"sales",'_preaccount'=>"account_receivable",'_invaccount'=>"account_receivable","_sign"=>'-1','client'=>'Customer','c_type'=>'1','_zero_balance'=>1,"_category"=>"date,Date,period,today|wharehouse,Location,warehouse","_customer_invoiceitem"=>"1");
	
	$param["receipt"]["_form"]["top"]="_prepayment,Prepayment,s12,pr|date,Date,s12 m3,d|ref,Receipt No,s12 m3,i|_account,Cash Account,s12 m3,ac,cashAccount|warehouse,Location,s12 m3,cb,warehouse";
	$param["receipt"]["_form"]["middle"]="itemid,&nbsp;Item,s12 m2,i|description,&nbsp;Description,s12 m4,i|quantity,Qty,s12 m1,i|rate,Rate,s12 m1,i|amount,Amount,s12 m2,i|joborder,Job,s12 m2,i";
		...
		//Payment Parameter
	$param["payment"]=array("t"=>"transactions","c"=>"date,Date,s,a|ref,reference,b,a|customer,vendor,s,a|amount,amount,s,a",'idcol'=>'trans_no','filter'=>"sub=0 and trans_type='PYT'",'page_title'=>'Payment','_type'=>'PYT','_glaccount'=>"inventory","_sign"=>'1','client'=>'Vendor','c_type'=>'2','_zero_balance'=>1,'show_account'=>1,"_category"=>"date,Date,period,today|wharehouse,Location,warehouse","_customer_invoiceitem"=>"1");
	
	$param["payment"]["_form"]["top"]="_prepayment,Prepayment,s12,pr|date,Date,s12 m3,d|ref,Invoice No,s12 m3,i|_account,Cash Account,s12 m3,ac,cashAccount|warehouse,Location,s12 m3,cb,warehouse";
	...
	$param["creditMemo"]=array("t"=>"transactions","c"=>"date,Date,s,a|ref,reference,b,a|customer,customer,s,a|amount,amount,s,a",'idcol'=>'trans_no','filter'=>"sub=0 and trans_type='CDM'",'page_title'=>'Credit Memo','_type'=>'CDM','_account'=>"account_receivable",'_glaccount'=>"sales","_sign"=>'1',"_glsign"=>'-1','client'=>'Customer','c_type'=>'1',"_category"=>"date,Date,period,today|wharehouse,Location,warehouse","_customer_invoiceitem"=>"2","_payment"=>1);
	
	$param["creditMemo"]["_form"]["top"]="date,Date,s12 m4,d|ref,Invoice No,s12 m4,i|warehouse,Location,s12 m4,cb,warehouse";
	$param["creditMemo"]["_form"]["middle"]="itemid,&nbsp;Item,s12 m2,i|description,&nbsp;Description,s12 m2,i|quantity,Qty,s12 m2,i|rate,Rate,s12 m2,i|amount,Amount,s12 m2,i";
		//End of Credit Memo parameter

		//Vendor Credit Parameter
	$param["vendorCredit"]=array("t"=>"transactions","c"=>"date,Date,s,a|ref,reference,b,a|customer,vendor,s,a|amount,amount,s,a",'idcol'=>'trans_no','filter'=>"sub=0 and trans_type='VCM'",'page_title'=>'Vendor Credit Memo','_type'=>'VCM','_account'=>"account_payable",'_glaccount'=>"inventory","_sign"=>'-1','client'=>'Vendor','c_type'=>'2',"_category"=>"date,Date,period,today|wharehouse,Location,warehouse","_customer_invoiceitem"=>"2");
	
	$param["vendorCredit"]["_form"]["top"]="date,Date,s12 m4,d|ref,Invoice No,s12 m4,i|warehouse,Location,s12 m4,cb,warehouse";
	$param["vendorCredit"]["_form"]["middle"]="itemid,&nbsp;Item,s12 m2,i|description,&nbsp;Description,s12 m2,i|quantity,Qty,s12 m2,i|rate,Rate,s12 m2,i|amount,Amount,s12 m2,i";
		//End of Vendor Credit parameter
		
		//General Journal Parameter
	$param["generalJournal"]=array("t"=>"transactions","c"=>"ref,reference,b,a|date,date,s,a",'idcol'=>'trans_no','filter'=>"sub=0 and trans_type='GNJ'",'page_title'=>'General Journal','_type'=>'GNJ','_account'=>"account_payable",'_glaccount'=>"inventory","_sign"=>'-1','client'=>'Vendor','c_type'=>'0',"_category"=>"date,Date,period,today|wharehouse,Warehouse,warehouse","_customer_invoiceitem"=>"2");
