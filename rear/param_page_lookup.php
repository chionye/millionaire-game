...
// Users Parameter
	...
	$param["item"]["_form"]["left"]["Description"]="upc,UPC,i,i|inactive,Status,r,sw,active|item_type,Product Line,r,cb,productType|warehouse,Location,i,s,warehouse|unit,Unit,Unit,i,i|weight,Weight,i,n|quantity_on_hand,Quantity on Hand,i,i";
		...
		$param["item"]["_form"]["right"]["Accounts"]="gl_sales_account,Sales Account,i,cb,incomeAccount|gl_inventory_account,Inventory Account,i,cb,inventoryAccount|gl_cos_account,Cost of Sale Account,i,cb,cosAccount";
	...
	$param["joborder"]["_form"]["center"]["Details"]="supervisor,Supervisor,i,cb,users|customer_name,Customer,r,cb,minicustomer|item_description,Item,i,cb,item|warehouse,Location,i,s,warehouse";
		...
		//Asset parameter
	$param["assets"]=array("t"=>"item","c"=>"description,
	Description,b,a|itemid,Item ID,s,a|unit_cost,Unit Cost,s,a",
	...
	$param["assets"]["_form"]["left"]["Description"]="upc,Identification Number,i,i|item_type,Asset Type,r,cb,productType|wharehouse,Location,i,s,warehouse|date_purchased,Date Purchased,i,d";
		$param["assets"]["_form"]["left"]["Cost & Depreciation"]="unit_cost,Unit Cost,n,i|price1,Depreciation,i,n|taxable,Taxable,i,i";
	...
	"c"=>"itemid,Item ID,s,a|description,Description,b,a|price1,Price,h,a|gl_cos_account,COS,h,a|gl_sales_account,SA,h,a|quantity_on_hand,Quantity,r,a",
	'idcol'=>'tid','newcol'=>'description','page_title'=>'Item','transcid'=>true,"extras"=>"asset_type=0",'filter'=>"asset_type=0 $_wd");	
...
$param["vendorInvoice"]=array("t"=>"transactions","c"=>"tid,tid,h,a|ref,reference,b,a|date,date,s,a|net_due,amount,r,a|trans_no,trans_no,h,a",'idcol'=>'tid','filter'=>"sub=0 and net_due>0 and trans_type='PCH'");
	...
	$param["productType"]=array("t"=>"category_type","c"=>"name,name,b,a","fixed"=>"category=3","newcol"=>'name','idcol'=>'typeid',"filter"=>'category=3');
	$param["customerType"]=array("t"=>"category_type","c"=>"name,name,b,a","fixed"=>"category=5","newcol"=>'name','idcol'=>'typeid',"filter"=>'category=5');
	
	$param["assestType"]=array("t"=>"category_type","c"=>"name,Name,i,l",'idcol'=>'typeid',"page_title"=>"Asset Type","sort_col"=>"name","filter"=>'category=3',"fixed"=>"category=3");
	...
	$param["incomeAccount"]=array("t"=>"account_chart","c"=>"account_id,Account ID,b,l|account_name,Account Name,s,l",'idcol'=>'typeid',"page_title"=>"Accounts",'filter'=>'account_type=21','default'=>'defaultCash');

	$param["inventoryAccount"]=array("t"=>"account_chart","c"=>"account_id,Account ID,b,l|account_name,Account Name,s,l",'idcol'=>'typeid',"page_title"=>"Accounts",'filter'=>'account_type=2','default'=>'defaultCash');

	$param["cosAccount"]=array("t"=>"account_chart","c"=>"account_id,Account ID,b,l|account_name,Account Name,s,l",'idcol'=>'typeid',"page_title"=>"Accounts",'filter'=>'account_type=23','default'=>'defaultCash');
	
	$param["expenseAccount"]=array("t"=>"account_chart","c"=>"account_id,Account ID,b,l|account_name,Account Name,s,l",'idcol'=>'typeid',"page_title"=>"Accounts",'filter'=>'account_type=24','default'=>'defaultCash');
