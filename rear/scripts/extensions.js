...
$.fn.extend(
{
	createRow: function(field,order)
	{
		...
		$.each(field.c, function(j, col)
		{
			...
			{
				nDiv.append($("<span></span>").text( + " ").addClass('col s'+num).css({'font-size':'11px','font-style':'italic'}));
...
$.fn.extend(
{
	uploadOptn: function(c, f)
	{
		...
		function(){
	 	...
	 	var uc_i = $('<i>').addClass('material-icons grey-text text-darken-1').html('more_vert').appendTo(uc_optn)
