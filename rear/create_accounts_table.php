...
`tid` int(10) unsigned NOT NULL AUTO_INCREMENT,
 `transcid` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `itemID` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
 `description` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
 `sales_desc` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
 `purchase_desc` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
 `upc` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
 `categories` int(200) DEFAULT NULL,
 `pcategories` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
 ...
 `sunit` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
 `subdivision` int(11) DEFAULT NULL,
 `weight` decimal(14,2) DEFAULT NULL,
 `unit_cost` decimal(14,2) DEFAULT NULL,
 `taxable` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
 ...
 `price6` float(10,2) DEFAULT NULL,
 `price7` float(10,2) DEFAULT NULL,
 `price8` float(10,2) DEFAULT NULL,
 `price9` float(10,2) DEFAULT NULL,
 `price10` float(10,2) DEFAULT NULL,
 ...
 `inactive` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
 `commission` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
 `costing_method` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
 `gl_sales_account` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `gl_inventory_account` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `gl_cos_account` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `minimum_stock` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `reorder_quantity` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `vendor_id` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `buyer_id` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `alternate_vendor` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `substitution` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `special_note` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
 `special_order` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `master_stock_id` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `primary_attrib_name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `substock_primary_attrib_id` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `substock_primary_attrib_desc` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `secondary_attrib_name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `substock_second_attrib_id` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `substock_second_attrib_desc` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `quantity_on_sales_orders` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `quantity_on_purchase_orders` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `quantity_on_hand` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
 `asset_type` int(11) DEFAULT NULL,
 `date_purchased` date DEFAULT NULL,
 `date_created` date DEFAULT NULL,
 `created_by` int(11) DEFAULT NULL,
 `clientid` int(11) DEFAULT NULL,
 `sold` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
 PRIMARY KEY (`tid`)
