<?php
		//Invoice Parameter
	$param["invoice"]=array("t"=>"transactions","c"=>"date,Date,s,a|ref,reference,b,a|customer,customer,s,a|amount,amount,s,a",'idcol'=>'trans_no','filter'=>"sub=0 and trans_type='INV' $_wd ",'page_title'=>'Sales Invoice','_type'=>'INV','_account'=>"account_receivable",'_glaccount'=>"sales","_sign"=>'-1','client'=>'Customer','c_type'=>'1',"_category"=>"date,Date,period,today|wharehouse,Location,warehouse","_customer_invoiceitem"=>"0","_payment"=>1,"_applied_credit"=>1);
	...
	$param["receipt"]["_form"]["middle"]="itemid,&nbsp;Item,s12 m2,i|description,&nbsp;Description,s12 m4,i|quantity,Qty,s12 m1,i|rate,Rate,s12 m1,i|amount,Amount,s12 m2,i|joborder,Job,s12 m2,i|account,Account,s12 m2,h";
		//End of receipt parameter

		//Payment Parameter
	$param["payment"]=array("t"=>"transactions","c"=>"date,Date,s,a|ref,reference,b,a|customer,vendor,s,a|amount,amount,s,a",'idcol'=>'trans_no','filter'=>"sub=0 and trans_type='PYT' $_wd ",'page_title'=>'Payment','_type'=>'PYT','_glaccount'=>"inventory","_sign"=>'1','client'=>'Vendor','c_type'=>'2','_zero_balance'=>1,'show_account'=>1,"_category"=>"date,Date,period,today|wharehouse,Location,warehouse","_customer_invoiceitem"=>"1");
	...
	$param["creditMemo"]=array("t"=>"transactions","c"=>"date,Date,s,a|ref,reference,b,a|customer,customer,s,a|amount,amount,s,a",'idcol'=>'trans_no','filter'=>"sub=0 and trans_type='CDM' $_wd ",'page_title'=>'Credit Memo','_type'=>'CDM','_account'=>"account_receivable",'_glaccount'=>"sales","_sign"=>'1',"_glsign"=>'-1','client'=>'Customer','c_type'=>'1',"_category"=>"date,Date,period,today|wharehouse,Location,warehouse","_customer_invoiceitem"=>"2","_payment"=>1);
	...
	$param["vendorCredit"]=array("t"=>"transactions","c"=>"date,Date,s,a|ref,reference,b,a|customer,vendor,s,a|amount,amount,s,a",'idcol'=>'trans_no','filter'=>"sub=0 and trans_type='VCM' $_wd ",'page_title'=>'Vendor Credit Memo','_type'=>'VCM','_account'=>"account_payable",'_glaccount'=>"inventory","_sign"=>'-1','client'=>'Vendor','c_type'=>'2',"_category"=>"date,Date,period,today|wharehouse,Location,warehouse","_customer_invoiceitem"=>"2");
