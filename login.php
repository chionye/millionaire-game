      ...
      <div class="row">
        ...
        <div class="col-md-5 ">
          <div class="d-md-flex justify-content-center align-items-center h-100">
            <div class="card shadow p-3" style="border-radius: 20px; border:none; width: 100%">
              <div class="card-body">
                <p class="display-4">Login Here</p>
                <form>
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary" onclick="log();return false">Submit</button>
                    <a href="signup.php" class="nav-link">Want to open an account? Sign up here</a>
                  </div>
                </form>
              </div>
            </div>
